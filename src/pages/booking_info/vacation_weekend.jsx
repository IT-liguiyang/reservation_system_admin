...
// 寒暑假周末
const VacationWeekend = (props) => {

  // 规定接收父元素的数据类型
  VacationWeekend.propTypes ={
    vacationWeekendSubmit:PropTypes.func.isRequired
  };
  ...
  var vacationWeekendList_from_child = [];
  ...
  const onFinish = (fieldsValue) => {
    ...
    if (!saturday_am && !saturday_pm && !sunday_am && !sunday_pm){
      vacationWeekendList_from_child = [];
      console.log(vacationWeekendList_from_child);
      props.vacationWeekendSubmit(vacationWeekendList_from_child);
      return;
    }
    ...
    vacationWeekendList_from_child = [timeList, areaList];
    console.log(vacationWeekendList_from_child);
    props.vacationWeekendSubmit(vacationWeekendList_from_child);
  };
...
export default VacationWeekend;