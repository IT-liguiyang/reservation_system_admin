...
// 寒暑假工作日
const VacationWorkday = (props) => {

  // 规定接收父元素的数据类型
  VacationWorkday.propTypes ={
    vacationWorkdaySubmit:PropTypes.func.isRequired
  };
  ...
  var vacationWorkdayList_from_child = [];
  ...
  const onFinish = (fieldsValue) => {
    ...
    if (!am && !pm){
      vacationWorkdayList_from_child = [];
      props.vacationWorkdaySubmit(vacationWorkdayList_from_child);
      return;
    }
    ...
    vacationWorkdayList_from_child = [timeList, areaList];
    console.log(vacationWorkdayList_from_child);
    props.vacationWorkdaySubmit(vacationWorkdayList_from_child);
  };
...
export default VacationWorkday;