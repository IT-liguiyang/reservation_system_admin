...
// 教学期间工作日
const SchooldayWorkday = (props) => {

  // 规定接收父元素的数据类型
  SchooldayWorkday.propTypes ={
    schooldayWorkdaySubmit:PropTypes.func.isRequired
  };
  ...
  var schooldayWorkdayList_from_child = [];
  ...
  const onFinish = (fieldsValue) => {
    ...
    if (!am && !pm){
      schooldayWorkdayList_from_child = [];
      // 向父元素传递
      props.schooldayWorkdaySubmit(schooldayWorkdayList_from_child);
      return;
    }
    ...
    schooldayWorkdayList_from_child = [timeList, areaList];

    console.log(schooldayWorkdayList_from_child);
    // 向父元素传递
    props.schooldayWorkdaySubmit(schooldayWorkdayList_from_child);
...
export default SchooldayWorkday;